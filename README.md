...
### 🧮 Основной этап — решение задач

**Ноутбук**: [`notebooks/01_main_stage_solver.ipynb`](notebooks/01_main_stage_solver.ipynb) \
...
### 📝 Полуфинал — поиск ошибок в решениях

**Ноутбук**: [`notebooks/02_semifinal_checker.ipynb`](notebooks/02_semifinal_checker.ipynb)  
...
### 🖼 Финал — рукописные решения

**Ноутбук**: [`notebooks/03_final_ocr.ipynb`](notebooks/03_final_ocr.ipynb)  
